...
const CaptainHome = () => {
    ...
    useGSAP(() => {
        if (ridePopupPanel) {
            gsap.to(ridePopupPanelRef.current, { transform: 'translateY(0)', duration: 0.4 })
        } else {
            gsap.to(ridePopupPanelRef.current, { transform: 'translateY(100%)', duration: 0.4 })
        }
    }, [ridePopupPanel])
    ...
    useGSAP(() => {
        if (confirmRidePopupPanel) {
            gsap.to(confirmRidePopupPanelRef.current, { transform: 'translateY(0)', duration: 0.4 })
        } else {
            gsap.to(confirmRidePopupPanelRef.current, { transform: 'translateY(100%)', duration: 0.4 })
        }
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <div className='fixed p-4 top-0 flex items-center justify-between w-screen z-10'>
                ...
                <Link to='/captain-login' className='h-10 w-10 bg-white flex items-center justify-center rounded-full shadow'>
