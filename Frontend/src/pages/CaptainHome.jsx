...
const CaptainHome = () => {
    ...
    // ✅ FIXED: guard against null captain, changed dependency to [captain]
    useEffect(() => {
    ...
    }, [ captain ]) // ✅ FIXED: was [], now [captain] so it runs when captain data loads

    // ✅ FIXED: socket.on inside useEffect with cleanup to prevent duplicate listeners
    useEffect(() => {
