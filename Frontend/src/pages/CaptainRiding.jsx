  ...
  return (
    <div className="h-screen relative">
      <div className="fixed p-6 top-0 flez items-center justify-between w-screen ">
        ...
        <Link
          to="/captain-home"
          className="fixed h-10 w-10 bg-white flex items-center justify-center rounded-full"
        >
      ...
      >
        <h5
          className="p-1 text-center w-[]95%] absolute top-0 flex justify-between items-center"
          onClick={() => {}}
        >
          <i className="text-3xl ri-arrow-drop-down-line text-gray-800"
          ></i>
        </h5>
